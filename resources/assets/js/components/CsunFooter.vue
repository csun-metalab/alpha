...
<footer class="footer-metaphor">
      ...
      <div class="col-12 col-md-5">
        <div class="row mb-3 mb-md-0">
          <div class="col-12 col-md-3">
              <img class="d-block mx-auto mx-md-0 img-fluid footer-metaphor__emblem mb-3 mb-md-0" src="//s3-us-west-2.amazonaws.com/metalab-fonts/images/csun-emblem.svg">
          </div>
  ...
  <div class="footer-metaphor__subfooter mt-5">
      <div class="container">
          <div class="row">
              <div class="col-md-2">
                  <img class="footer-metaphor__logo mb-3" src="//s3-us-west-2.amazonaws.com/metalab-fonts/images/metalab-logo.svg">
